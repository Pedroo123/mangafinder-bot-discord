...
async def search(ctx, *, query: str):
    ...
    try:
        ...
        # Search with a 15-second timeout
        ...
        # Batch results into groups of up to 5 embeds per message
        batch_size = 5
        ...
        await ctx.send("The search took too long. Please try a more specific query.")
