...
async def search(ctx, *, query: str):
    ...
    try:
        ...
        # Adding a timeout to ensure the bot doesn't hang
        ...
        # We batch them to reduce message count and improve UI
        batch_size = 5
        ...
        await ctx.send("The search took too long. Please try again later.")
    except Exception as e:
